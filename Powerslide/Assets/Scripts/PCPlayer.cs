...
///* NOTE 
// * This player is an old version of the Player script to be used when testing on the PC version of the game
// * NOT TO BE USED IN BUILDS TO ANDROID
// * 以上～ */
...
//                    Debug.Log("ANDROID DEBUG: ADDED " + Input.touches[i].phase.ToString() + ", total number of fingers: " + Input.touches.Length);
//                }
//            }
...
//                {
//                    Debug.Log("ANDROID DEBUG: REMOVED" + Input.touches[i].phase.ToString() + ", total number of fingers: " + Input.touches.Length);
